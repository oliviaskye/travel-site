...
const Hotels = ({ searchData }) => {
  ...
  return (
    <div className="hotels-container" style={{ maxHeight: "80vh", paddingRight: "15px" }}>
      {hotels.length > 0 ? (
        hotels.map((hotel) => (
          <div key={hotel._id} className="hotel-card">
            ...
            <div className="hotel-info">
              ...
              <div className="loaction">
                <p>
                  <FaMapMarkerAlt style={{ marginRight: "8px", color: "gray", paddingLeft: "10vh" }} />
                </p>
              ...
              <Link
                ...
                onClick={() => localStorage.setItem("selectedHotel", JSON.stringify(hotel))}
